...
builder.Services.AddHttpClient<DisconnectTctService>();
builder.Services.AddHttpClient<BillDetailService>();
builder.Services.AddHttpClient<BillListService>();
builder.Services.AddHttpClient<SyncInvoiceTctService>();
builder.Services.AddHttpClient<ImportXMLService>();
builder.Services.AddHttpClient<PreviewBase64Service>();
