            ...
            using (var connection = new SqlConnection(connectionString)) 
            {
                ...
                foreach (var invoiceDetail in invoiceDetails) 
                {
                    ...
                    WHEN NOT MATCHED THEN 
                        ...
                        VALUES (
                            source.MaHoaDon, source.MaLichSuFIle, source.TenHoaDon, source.KiHieuMauSoHoaDon, source.SoHoaDon, source.NgayLap, source.NgayDuyet, source.NgayNhan, source.NgayThanhToan, NgayKy,
                ...
                ", connection);
                    ...
                    insertHoaDonDetail.Parameters.AddWithValue("@NgayDuyet", (object?)invoiceDetail.ngayDuyet ?? DBNull.Value);
                    insertHoaDonDetail.Parameters.AddWithValue("@NgayNhan", (object?)invoiceDetail.ngayNhan ?? DBNull.Value);
                    insertHoaDonDetail.Parameters.AddWithValue("@NgayThanhToan", (object?)invoiceDetail.ngayThanhToan ?? DBNull.Value);
                    insertHoaDonDetail.Parameters.AddWithValue("@NgayKy", (object?)invoiceDetail.ngayKy ?? DBNull.Value);
                    ...
                    insertHoaDonDetail.Parameters.AddWithValue("@TongTienChietKhauThuongMai", invoiceDetail.tongTienChietKhauThuongMai);
                    ...
                    insertHoaDonDetail.Parameters.AddWithValue("@CheckMstNguoiMua", invoiceDetail.checkMstNguoiMua);
                    insertHoaDonDetail.Parameters.AddWithValue("@CheckDiaChiNguoiMua", invoiceDetail.checkDiaChiNguoiMua);
                    insertHoaDonDetail.Parameters.AddWithValue("@CheckTenNguoiMua", invoiceDetail.checkTenNguoiMua);
                    ...
                    //DateTime parsedNgayDuyet = DateTime.ParseExact(invoiceDetail.ngayDuyet ?? throw new Exception("ngayDuyet is required"), format, culture);
                    //DateTime parsedNgayNhan = DateTime.ParseExact(invoiceDetail.ngayNhan ?? throw new Exception("ngayNhan is required"), format, culture);
                    //DateTime parsedNgayThanhToan = DateTime.ParseExact(invoiceDetail.ngayThanhToan ?? throw new Exception("ngayThanhToan is required"), format, culture);
                    //DateTime parsedNgayKy = DateTime.ParseExact(invoiceDetail.ngayKy ?? throw new Exception("ngayKy is required"), format, culture);
                    ...
                    if (invoiceDetail.maHoaDon != null && invoiceDetail.dsHangHoa != null)
                    {
                        ...
                        MERGE INTO DANH_SACH_HANG_HOA AS target
                            USING (SELECT
                                ...
                                @TenHangHoa as TenHangHoa, @DonGia as DonGia, @Loai as Loai, @DonViTinh, 
                            ...
                            WHEN NOT MATCHED THEN 
                                INSERT ( 
                                    id, khuyenMai, stt, tenHangHoa, donGia, loai, donViTinh, 
                                    soLuong, thanhTien, thueSuat, tienThue, checkSua
                                )
                                VALUES (
                                    source.id, source.khuyenMai, source.stt, source.tenHangHoa, source.donGia, source.loai, source.donViTinh, 
                    ...
                    if (invoiceDetail.maHoaDon != null && invoiceDetail.dsThueSuat != null)
                    {
                        ...
                        MERGE INTO DANH_SACH_THUE_SUAT AS target
                            ...
                            WHEN NOT MATCHED THEN 
                                INSERT ( 
                                    id, thueSuat, tienThue
                                )
                                VALUES (
                                    source.id, source.thueSuat, source.tienThue
                                );
                            ", connection);
